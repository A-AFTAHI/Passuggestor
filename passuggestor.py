...
# NameFormatting : This method takes the company's name and produces diffrent versions based on letters case

def NameFormatting (corp):
...
def main(): 
  ...
  try:
    ...
    corpList = NameFormatting(corp)  # The corporation names list
